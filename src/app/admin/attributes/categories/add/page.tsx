  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      if (res.isSuccess) {
        ...
        toastError(res.error?.description || "Không thể tạo danh mục");
      }
    } catch {
      toastError("Lỗi hệ thống khi tạo danh mục");
    } finally {
      ...
      <PageHeader
        ...
        actions={
          <div className="flex gap-3">
            ...
            >
              <MdAdd className="text-lg" /> {isProcessing ? "Đang xử lý..." : "Tạo danh mục"}
            </button>
          </div>
        }
      />
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="Nhập tên danh mục (ví dụ: Gấu bông, Phụ kiện...)"
        ...
        <div className="lg:col-span-4 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-6 bg-[#F4F7FF] rounded-[24px] border border-transparent hover:border-blue-100 transition-all shadow-sm">
                <div className="text-left">
                  ...
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider text-left">Kích hoạt ngay</p>
                </div>
                <button
                  type="button"
          ...
          <section className="ac bg-white rounded-[32px] p-8 shadow-sm border border-white/50 space-y-6">
            ...
            <p className="text-sm text-gray-400 font-semibold leading-relaxed">
              Tạo danh mục mới sẽ giúp bạn phân loại sản phẩm tốt hơn trong kho hàng và trên trang cửa hàng trực tuyến.
            </p>
          </section>
        </div>
      </div>

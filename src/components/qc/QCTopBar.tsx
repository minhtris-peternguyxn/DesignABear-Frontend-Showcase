...
const TABS = [
  { label: "TỔNG QUAN", href: "/qc", icon: MdDashboard },
  { label: "KIỂM ĐỊNH", href: "/qc/inspections", icon: MdChecklist },
];
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        <div className="hidden sm:flex items-center gap-2 bg-white/10 rounded-xl px-3 py-1.5">
          <MdFactCheck className="text-white/60 text-sm" />

...
export default function StoryPromise() {
  ...
  const translatedPromises = [
    {
      ...STORY_PROMISES[0],
      title: t.story.promise.p1.title,
      detail: t.story.promise.p1.detail,
    },
    {
      ...STORY_PROMISES[1],
      title: t.story.promise.p2.title,
      detail: t.story.promise.p2.detail,
    },
    {
      ...STORY_PROMISES[2],
      title: t.story.promise.p3.title,
      detail: t.story.promise.p3.detail,
    },
  ];
        ...
        <div className="relative">
          ...
          <div className="story-panel rounded-3xl bg-[#17409A] text-white p-7 md:p-10 lg:p-12">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
              ...
              >
                {t.story.promise.exploreBtn}
              </Link>
            </div>

            <div className="mt-8 grid md:grid-cols-3 gap-4">
              {translatedPromises.map((item) => (
                <article
                  key={item.id}
